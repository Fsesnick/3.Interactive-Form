...
window.addEventListener("load", () => {
	...
	document.getElementById("other-job-role").style.display = "none"; //"Other job role" should be hidden by default
...
JobRole.addEventListener("change", (evt) => {
	if (evt.target.value === "other") {
		document.getElementById("other-job-role").style.display = '';
	} else {
...
const ActivitiesValidator = () => {
	...
	console.log(
		`Activities section validation test evaluates to ${ActivitiesIsValid}`
	);
